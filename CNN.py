...
expr_filename = '/data/home/jianping/Desktop/CB2_new/chembl_10.csv'
...
fingerprint_filename = '/data/home/jianping/Desktop/CB2_new/cnn/fingerprints/fingerprint_chembl10.pkl'
...
if expr_filename == '/data/home/jianping/Desktop/CB2_new/chembl_10.csv':
    test_type = 'drug-like'
progress_train_filename = '/data/home/jianping/Desktop/CB2/deep_learn/cnn/output/train/CNN_fingerprint_train_NN-' + neural_net_present + '_' + test_type + '.csv'
progress_val_filename = '/data/home/jianping/Desktop/CB2/deep_learn/cnn/output/val/CNN_fingerprint_val_NN-' + neural_net_present + '_' + test_type + '.csv'
progress_train_output_df = pd.DataFrame()
progress_val_output_df = pd.DataFrame()
...
for epoch in xrange(num_epochs):
    print epoch
    progress_filename_train = '/data/home/jianping/Desktop/CB2/cnn/batch350/log_files/train/drug_like_train-' + str(epoch) + neural_net_present + '_' + test_type + '.csv'
    progress_filename_val = '/data/home/jianping/Desktop/CB2/cnn/batch350/log_files/val/drug_like_val-' + str(epoch) + neural_net_present + '_' + test_type  + '.csv'
...
progress_filename_test = '/data/home/jianping/Desktop/CB2/cnn/batch350/log_files/test/drug_like_test-' + neural_net_present + '_' + test_type  + '.csv'
...
tcm_expr_filename ='/data/home/jianping/Desktop/CB2_new/chemdiv_20w/20w_6.csv'
#tcm_fingerprint_filename = '/home/jianping/Desktop/wangmukuo/Dual_antagonist/Chemdiv/fingerprint/ch1000.pkl'
tcm_fingerprint_filename = '/data/home/jianping/Desktop/CB2_new/cnn/fingerprints/fingerprint_6.pkl'
smiles_to_measurement,smiles_to_atom_info,smiles_to_bond_info,\
    smiles_to_atom_neighbors,smiles_to_bond_neighbors,smiles_to_atom_mask,\
    smiles_to_rdkit_list,max_atom_len,max_bond_len,num_atom_features,num_bond_features\
...
progress_filename_test = '/data/home/jianping/Desktop/CB2/cnn/screen_result/6_drug_like_chemdiv_screen-' + neural_net_present + '_' + test_type  + '.csv'
output_test_df = pd.DataFrame()
for counter, experiment_list in enumerate(expr_list_of_lists):
    temp_test_df = pd.DataFrame()
    # print counter, experiment_list

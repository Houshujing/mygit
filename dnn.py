...
fingerprint_filename = '/data/home/jianping/Desktop/CB2_new/dnn/output/fingerprint/chembl10_fingerprints_2048.csv'
...
progress_train_filename = '/data/home/jianping/Desktop/CB2/deep_learn/ecfpdnn/output/progress_files/train/NN_ecfp_train-' + neural_net_present + '_' + test_type + '.csv'
progress_val_filename = '/data/home/jianping/Desktop/CB2/deep_learn/ecfpdnn/output/progress_files/val/NN_ecfp_val-' + neural_net_present + '_' + test_type + '.csv'
...
for epoch in xrange(num_epochs):
    print epoch
    progress_filename_train = '/data/home/jianping/Desktop/CB2/dnn/batch300/log_files/train/drug_like_train-' + str(
        epoch) + neural_net_present + '_' + test_type + '.csv'
    progress_filename_val = '/data/home/jianping/Desktop/CB2/dnn/batch300/log_files/val/drug_like_val-' + str(
        epoch) + neural_net_present + '_' + test_type + '.csv'
...
progress_filename_test = '/data/home/jianping/Desktop/CB2/dnn/batch300/log_files/test/drug_like_test-' + neural_net_present + '_' + test_type  + '.csv'
...
tcm_expr_filename = '/data/home/jianping/Desktop/CB2/chemdiv_50w/avaliablechemdiv2020_2.csv'
tcm_fingerprint_filename = '/data/home/jianping/Desktop/CB2/dnn/fingerprint/dual_fingerprints_2_2048.csv'
...
progress_filename_test = '/data/home/jianping/Desktop/CB2/dnn/ecfp_screen_test/test/2_drug_like_yatcm_test_' + neural_net_present + '_' + test_type  + '.csv'
output_test_df = pd.DataFrame()
for counter, experiment_list in enumerate(expr_list_of_lists):
    temp_test_df = pd.DataFrame()
    # print counter, experiment_list

...
input_filename = '/data/home/jianping/Desktop/CB2_new/chembl_10.csv'

# output_filename = '../../data/temp/solubility_control_fingerprints_'+str(num_bits)+'_1.csv'
output_filename = '/data/home/jianping/Desktop/CB2_new/dnn/output/fingerprint/chembl10_fingerprints_' + str(num_bits) + '.csv'
